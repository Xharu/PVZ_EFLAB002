...
#include "PVZ_EFLAB02/ZombieNormal.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	PVZ_EFLAB02_API UClass* Z_Construct_UClass_AZombieNormal_NoRegister();
	PVZ_EFLAB02_API UClass* Z_Construct_UClass_AZombieNormal();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AZombieNormal_Statics::Class_MetaDataParams[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AZombieNormal_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UStateInterface_NoRegister, (int32)VTABLE_OFFSET(AZombieNormal, IStateInterface), false },
		};
	...
	IMPLEMENT_CLASS(AZombieNormal, 2475331456);
	template<> PVZ_EFLAB02_API UClass* StaticClass<AZombieNormal>()
	{
		return AZombieNormal::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AZombieNormal(Z_Construct_UClass_AZombieNormal, &AZombieNormal::StaticClass, TEXT("/Script/PVZ_EFLAB02"), TEXT("AZombieNormal"), false, nullptr, nullptr, nullptr);
